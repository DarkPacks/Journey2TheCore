...
execute as @s run bossbar set bar value 0
...
#Start Timer
function sbt:test
execute as @s run bossbar set minecraft:test2 visible true

#Color
execute as @s run bossbar set bar color blue
function bossbar:bossbar/stage/1
execute as @s run bossbar set bar visible true
