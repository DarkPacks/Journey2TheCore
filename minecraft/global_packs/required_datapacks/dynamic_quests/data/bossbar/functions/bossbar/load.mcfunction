...
#stage 3
scoreboard objectives add punched_passive minecraft.custom:minecraft.entity_killed_passive
...
#stage 24
scoreboard objectives add kill_hostile_mob minecraft.custom:minecraft.entity_killed_hostile
