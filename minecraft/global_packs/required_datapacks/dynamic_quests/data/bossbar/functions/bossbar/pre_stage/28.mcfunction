...
se action @s playerbossbar set quest_tracker name [{"text":"Fire a Crossbow "},{"score":{"objective":"quest_quantity","name":"@s"}},{"text":" Times"}]
...
function bossbar:bossbar/stage/28
