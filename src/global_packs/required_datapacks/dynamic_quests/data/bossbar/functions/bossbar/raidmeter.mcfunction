...
execute as @s run raidmeter add quest "Twitch Quest Progress..." 50000 0 BOTTOM_RIGHT HORIZONTAL_THIN
...
execute as @s run raidmeter add raid "Hype Train Progress..." 5 0 BOTTOM_LEFT HORIZONTAL_THIN
